...
class __$$NoConnectionImplCopyWithImpl<T, $Res>
    extends _$LoginStateCopyWithImpl<T, $Res, _$NoConnectionImpl<T>>
...
class _$NoConnectionImpl<T> implements NoConnection<T> {
  const _$NoConnectionImpl();

  @override
  String toString() {
    return 'LoginState<$T>.noConnection()';
  }
...
abstract class NoConnection<T> implements LoginState<T> {
  const factory NoConnection() = _$NoConnectionImpl<T>;
}
